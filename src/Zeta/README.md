...
- **ASP.NET Core compatible** - Use `Zeta.AspNetCore` for Minimal APIs and Controllers
...
- `Zeta.AspNetCore`: Add this for ASP.NET Core web integration (Minimal APIs, Controllers, endpoint filters).
