...
public class CollectionSchemaTests
{
    ...
    {
        var schema = Z.Array(Z.Int().Min(0));
    ...
    {
        var schema = Z.Array(Z.String()).MinLength(2);
    ...
    {
        var schema = Z.Array(Z.String()).MaxLength(2);
    ...
    {
        var schema = Z.Array(Z.String()).NotEmpty();
    ...
    {
        var schema = Z.List(Z.String().Email());
    ...
    {
        var schema = Z.List(Z.Int()).MinLength(3);
    ...
    public async Task Array_NestedInObject_PropagatesPath()
    {
        var schema = Z.Object<Order>()
            .Field(o => o.Items, Z.Array(Z.String().MinLength(3)));
