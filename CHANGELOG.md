...
- Sample: `samples/Zeta.Sample.MediatR` — MediatR pipeline behavior validating via `IZetaValidator`, static schema-as-value contract, and a validation-aware `Result<TContext>` factory that turns a missing prerequisite into an aggregated error.
